// src/lib.rs
/*
 * Core library for PostScheduler
 */
...
#[derive(Debug)]
pub struct PostSchedulerProcessor {
    verbose: bool,
    processed_count: usize,
}

impl PostSchedulerProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting PostScheduler processing");
    
    let mut processor = PostSchedulerProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = PostSchedulerProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = PostSchedulerProcessor::new(false);
